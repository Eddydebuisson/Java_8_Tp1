...
public class Function_01_Test {
    ...
    private Function<Integer, Person> intToPerson = p -> { return new Person( "first_".concat(String.valueOf(p)), "last_".concat(String.valueOf(p)), p, "pass_".concat(String.valueOf(p))); };
    // end::intToPerson[]
    ...
    private Function<Person, Account> personToAccount = p -> { Account a = new Account(); a.setOwner(p);a.setBalance(1000);return a;};
    // end::personToAccount[]
